        ...
        <div className="row">
          ...
          <section className="col-lg-7 connectedSortable">
                ...
                <div className="card-tools">
                  <ul className="nav nav-pills ml-auto">
                    <li className="nav-item">
                      <a className="nav-link active" href="#revenue-chart" data-toggle="tab">New Users</a>
                    </li>
                    <li className="nav-item">
                      <a className="nav-link" href="#sales-chart" data-toggle="tab">Old Users</a>
                    </li>
                  </ul>
                </div>
              </div>{/* /.card-header */}
            ...
            <div className="card direct-chat direct-chat-primary">
              <div className="card-header">
                <h3 className="card-title">Chat With Users</h3>
                <div className="card-tools">
                ...
                <div className="direct-chat-messages">
                  ...
                  <div className="direct-chat-msg">
                    <div className="direct-chat-infos clearfix">
                      <span className="direct-chat-name float-left">Maneesh Kumar</span>
                      <span className="direct-chat-timestamp float-right">23 OCT 2:00 pm</span>
                    </div>
                    {/* /.direct-chat-infos */}
                    <img className="direct-chat-img" src="images/Maneesh.jpg" alt="message user image" />
                    {/* /.direct-chat-img */}
                    <div className="direct-chat-text">
                      Hey, hello dear, Hope you are doing grate
                    </div>
                    {/* /.direct-chat-text */}
                  </div>
                  {/* /.direct-chat-msg */}
                  ...
                  <div className="direct-chat-msg right">
                    <div className="direct-chat-infos clearfix">
                      <span className="direct-chat-name float-right">Sparrow</span>
                      <span className="direct-chat-timestamp float-left">23 OCT 2:05 pm</span>
                    </div>
                    {/* /.direct-chat-infos */}
                    <img className="direct-chat-img" src="images/sparrow.jpg" alt="message user image" />
                    {/* /.direct-chat-img */}
                    <div className="direct-chat-text">
                      Hey, yes I am good!
                    </div>
                  ...
                  <div className="direct-chat-msg">
                    <div className="direct-chat-infos clearfix">
                      <span className="direct-chat-name float-left">Maneesh Kumar</span>
                      <span className="direct-chat-timestamp float-right">23 OCT 5:37 pm</span>
                    </div>
                    {/* /.direct-chat-infos */}
                    <img className="direct-chat-img" src="images/Maneesh.jpg" alt="message user image" />
                    {/* /.direct-chat-img */}
                    <div className="direct-chat-text">
                      Have you completed your work wich was given by sir?
                    </div>
                    {/* /.direct-chat-text */}
                  </div>
                  {/* /.direct-chat-msg */}
                  ...
                  <div className="direct-chat-msg right">
                    <div className="direct-chat-infos clearfix">
                      <span className="direct-chat-name float-right">Sparrow</span>
                      <span className="direct-chat-timestamp float-left">23 OCT 6:10 pm</span>
                    </div>
                    {/* /.direct-chat-infos */}
                    <img className="direct-chat-img" src="images/sparrow.jpg" alt="message user image" />
                    {/* /.direct-chat-img */}
                    <div className="direct-chat-text">
                      No, But currently I am working on it I will complete it before the time
                    </div>
                    {/* /.direct-chat-text */}
                  </div>
                  {/* /.direct-chat-msg */}
